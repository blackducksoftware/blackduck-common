...
public class HubSupportHelper {
	 ...
	 *
	 */
	public void checkHubSupport(final HubIntRestService service, final IntLogger logger) throws IOException, URISyntaxException {
		try {
	 ...
	 *
	 */
	private boolean compareVersion(final String hubServerVersion, final String testVersion, final HubIntRestService service) throws IOException, BDRestException,
	URISyntaxException {
		try {
	 ...
	 *
	 */
	private boolean fallBackComparison(final String testVersion, final HubIntRestService service) throws IOException, BDRestException, URISyntaxException {
