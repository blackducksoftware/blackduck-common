...
public class SignatureScannerCertificateClient extends IntHttpClient {
    ...
    public SignatureScannerCertificateClient(IntHttpClient blackDuckHttpClient) {
    ...
    @Override
    public Optional<Response> executeGetRequestIfModifiedSince(Request request, long timeToCheck) throws IntegrationException {
        BasicHttpContext httpContext = new BasicHttpContext();
        Optional<Response> response = super.executeGetRequestIfModifiedSince(request, timeToCheck, httpContext);
