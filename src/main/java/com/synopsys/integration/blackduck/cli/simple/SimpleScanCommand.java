...
public class SimpleScanCommand {
    ...
    public SimpleScanCommand(final IntLogger logger, final SimpleScanPaths scannerPaths, final SimpleScanData simpleScanData, final String specificRunOutputDirectoryPath) throws HubIntegrationException, EncryptionException {
    ...
    private void setupScanCommand(final IntLogger logger, final SimpleScanPaths scannerPaths, final String specificRunOutputDirectoryPath) throws IllegalArgumentException, EncryptionException, HubIntegrationException {
