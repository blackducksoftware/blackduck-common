...
public class RapidScanWaiterTest {
    ...
    public void testWaitSuccess() throws Exception {
        ...
        Mockito.when(blackDuckApiClient.getAllResponses(Mockito.any(BlackDuckMultipleRequest.class))).thenReturn(expectedResults);
    ...
    public void testWaitLongerThanTimeout() throws Exception {
        ...
        Mockito.when(blackDuckApiClient.getAllResponses(Mockito.any(BlackDuckMultipleRequest.class))).thenReturn(new ArrayList());
