...
public class DetailedReleaseSummaryTest {
    ...
    public void testDetailedReleaseSummary() {
        ...
        DetailedReleaseSummary item1 = new DetailedReleaseSummary(projectId1, versionId1, projectName1, version1,
                versionComments1, nickname1, releasedOn1, phase1, distribution1, uiUrlGenerator1);
        DetailedReleaseSummary item2 = new DetailedReleaseSummary(projectId2, versionId2, projectName2, version2,
                versionComments2, nickname2, releasedOn2, phase2, distribution2, uiUrlGenerator2);
        DetailedReleaseSummary item3 = new DetailedReleaseSummary(projectId1, versionId1, projectName1, version1,
                versionComments1, nickname1, releasedOn1, phase1, distribution1, uiUrlGenerator1);
        DetailedReleaseSummary item4 = new DetailedReleaseSummary(null, null, null, null, null, null, null, null, null,
                null);
