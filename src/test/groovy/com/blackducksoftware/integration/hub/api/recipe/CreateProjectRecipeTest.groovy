...
class CreateProjectRecipeTest {
    ...
    void testCreatingAProject() {
        ...
        //any usage of the Hub API's has to begin with a url for the hub server
        //and either:
        // an API key
        // --or--
        ...
        //next, we need to create the pieces needed for the HubServicesFactory,
        //the wrapper to get/use all the Hub API's
        ...
        ProjectVersionView projectVersionView = hubService.getResponseFromLinkResponse(ProjectView.CANONICALVERSION_LINK_RESPONSE)
