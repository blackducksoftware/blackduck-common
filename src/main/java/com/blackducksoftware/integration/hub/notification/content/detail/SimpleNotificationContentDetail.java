...
public class SimpleNotificationContentDetail extends Stringable {
    ...
    // @formatter:off
    public static SimpleNotificationContentDetail createDetail(
        ...
        return new SimpleNotificationContentDetail(
                notificationGroup
                ,projectName
                ,projectVersionName
                ,projectVersionUri
    ...
    // @formatter:off
    private SimpleNotificationContentDetail(
            final String notificationGroup
            ,final Optional<String> projectName
            ,final Optional<String> projectVersionName
