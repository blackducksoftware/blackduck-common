...
public class EntityTypeEnumTest {
	...
	public void testGetEntityTypeEnum() {
		...
		assertEquals(EntityTypeEnum.UNKNOWNENTITY,
				EntityTypeEnum.getEntityTypeEnum(EntityTypeEnum.UNKNOWNENTITY.toString().toLowerCase()));
		assertEquals(EntityTypeEnum.UNKNOWNENTITY,
				EntityTypeEnum.getEntityTypeEnum(EntityTypeEnum.UNKNOWNENTITY.toString()));
