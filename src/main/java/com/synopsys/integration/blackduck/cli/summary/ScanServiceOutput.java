 ...
 * under the License.
 */
package com.synopsys.integration.blackduck.cli.summary;
...
public class ScanServiceOutput {
    ...
    public ScanServiceOutput(final ProjectVersionWrapper projectVersionWrapper, final List<ScanTargetOutput> scanTargetOutputs) {
