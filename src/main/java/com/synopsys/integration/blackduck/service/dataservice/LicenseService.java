...
public class LicenseService extends DataService {
    ...
    public LicenseService(BlackDuckApiClient blackDuckApiClient, BlackDuckApiFactories blackDuckApiFactories, IntLogger logger, ComponentService componentDataService) {
