...
class BlackDuckResponsesTransformerTestIT {
    ...
    void testGetResponsesWithMaxLimit() throws IntegrationException {
        ...
        final BlackDuckPageResponse<ProjectView> underPageSizeResponse = blackDuckResponsesTransformer.getSomeResponses(oversizePagedRequest, ApiDiscovery.PROJECTS_LINK_RESPONSE.getResponseClass(), 2);
        ...
        final PagedRequest limitedPagedRequest = new PagedRequest(requestBuilder, 0, 2);
        final BlackDuckPageResponse<ProjectView> limitedResponses = blackDuckResponsesTransformer.getSomeResponses(limitedPagedRequest, ApiDiscovery.PROJECTS_LINK_RESPONSE.getResponseClass(), 5);
    ...
    private BlackDuckResponsesTransformer createBlackDuckResponsesTransformer() throws IntegrationException {
        ...
        return new BlackDuckResponsesTransformer(blackDuckServicesFactory.getBlackDuckHttpClient(), blackDuckJsonTransformer, new MediaTypeDiscovery());
    }
