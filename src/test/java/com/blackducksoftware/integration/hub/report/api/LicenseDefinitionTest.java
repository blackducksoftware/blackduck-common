...
public class LicenseDefinitionTest {
    ...
    public void testLicenseDefinition() {
        ...
        LicenseDefinition item1 = new LicenseDefinition(licenseId1, discoveredAs1, name1, spdxId1, ownership1,
                codeSharing1, licenseDisplay1);
        LicenseDefinition item2 = new LicenseDefinition(licenseId2, discoveredAs2, name2, spdxId2, ownership2,
                codeSharing2, licenseDisplay2);
        LicenseDefinition item3 = new LicenseDefinition(licenseId1, discoveredAs1, name1, spdxId1, ownership1,
                codeSharing1, licenseDisplay1);
        ...
        item1 = new LicenseDefinition(null, null, null, null, null, null, null);
        assertNull(item1.getLicenseUUId());
